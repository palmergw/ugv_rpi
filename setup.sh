...
sudo apt update
sudo apt upgrade -y
sudo apt install -y libopenblas-dev libatlas3-base libcamera-dev python3-opencv portaudio19-dev libsmbclient-dev libcap-dev libxml2-dev libxslt1-dev libcups2-dev
